import { TextoContract, type TextoContractType } from "@car/models";
...
const TextosListResponse = z.array(TextoContract);

export class TextoService {
	@Inject(TextoRepository)
	private repository!: IMongoRepository<DocZod<TextoContractType>>;
