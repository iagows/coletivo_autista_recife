import { RegraModelMongoDB, type RegraModelTypeMongoDB } from "@car/models";
...
const RegrasListResponse = z.array(RegraModelMongoDB);

export class RegraService {
	@Inject(RegraRepository)
	private repository!: IMongoRepository<DocZod<RegraModelTypeMongoDB>>;
