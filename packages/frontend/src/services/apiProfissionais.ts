...
import LinkModel, {
	type LinkModelType,../../../packages/models/src/PlanoModel
} from "../../../packages/model../../../packages/models/src/ProfissionalModel
import PlanoModel, { type PlanoModelType } from "../models/PlanoModel";
import ProfissionalModel from "../models/ProfissionalModel";
import TelefoneModel, { type TelefoneModelType } from "../../../models/src/TelefoneModel";
import EspecialidadeProfissionalModel from "../../../models/src/relation/EspecialidadeProfissionalModel";
import PlanoProfissionalModel from "../../../models/src/relation/PlanoProfissionalModel";
